...
class type _t = [@bs] {
  ...
  /**
    Copies x and y from the given point
      ...
      @see </docs/FormationEmbedCore/PIXI-Formationembedcore/IPoint/#val-copyFrom> IPoint.copyFrom
  ...
  /**
    Copies x and y into the given point
      ...
      @see </docs/FormationEmbedCore/PIXI-Formationembedcore/IPoint/#val-copyTo> IPoint.copyTo
  ...
  /**
    Returns true if the given point is equal to this point
      ...
      @see </docs/FormationEmbedCore/PIXI-Formationembedcore/IPoint/#val-equals> Point.equals
  ...
  /**
    ...
    If y is omitted, both x and y will be set to x.
      ...
      @param x (optional) position of the point on the x axis
      @param y (optional) position of the point on the y axis
   */
  pub set: (Js.Undefined.t(float), Js.Undefined.t(float)) => unit;
};
...
/**
  Returns true if the given point is equal to this point
    ...
    @deprecated consider using IPoint.equals instead for ObservablePoint support
    @see </docs/FormationEmbedCore/PIXI-Formationembedcore/IPoint/#val-equals> IPoint.equals
    @param p The point to check
    @return Whether the given point equal to this point
 */
[@bs.send]
